package com.wiqer.io.netty.channel.nio;
...
public class NioSingleEventLoop extends SingleThreadEventLoop {
    ...
    NioSingleEventLoop(NioSingleEventLoopGroup parent, Executor executor, SelectorProvider selectorProvider,
        ...
        final NioSingleEventLoop.SelectorTuple selectorTuple = openSelector();
    ...
    private SelectorTuple openSelector() {
        ...
        if (DISABLE_KEY_SET_OPTIMIZATION) {
            return new NioSingleEventLoop.SelectorTuple(unwrappedSelector);
        }
    ...
    private void rebuildSelector0() {
        ...
        final NioSingleEventLoop.SelectorTuple newSelectorTuple;
